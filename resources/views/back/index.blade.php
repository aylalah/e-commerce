...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="{{url('Dashboard')}}">Start Bootstrap</a>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="login.html">Add Staff</a>
          <a class="dropdown-item" href="register.html">View Staff</a>
          {{-- <a class="dropdown-item" href="forgot-password.html">Forgot Password</a> --}}
          <div class="dropdown-divider"></div>
          <h6 class="dropdown-header">Users:</h6>
          <a class="dropdown-item" href="404.html">Add User</a>
          <a class="dropdown-item" href="blank.html">View Users</a>
        </div>
      </li>
      <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="pagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
              ...
              <a class="dropdown-item" href="login.html">Wears</a>
              <a class="dropdown-item" href="register.html">Shoes</a>
              {{-- <a class="dropdown-item" href="forgot-password.html">Forgot Password</a> --}}
              <div class="dropdown-divider"></div>
