              ...
              <div class="row">
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="{{ asset('/upload/product/'.$data-> slug)}}" class="simpleLens-lens-image"><img src="{{ asset('/upload/product/'.$data-> slug)}}" class="simpleLens-big-image"></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <span class="aa-product-view-price">N{{$data-> price}}</span>
                      <p class="aa-product-avilability">Avilability: <span>{{$data-> status}}</span></p>
                    </div>
                    ...
                    <div class="aa-prod-quantity">
                      ...
                      <p class="aa-prod-category">
                        Category: <a href="#">{{$data->category}}</a>
                      </p>
                    </div>
                    <div class="aa-prod-view-bottom">
                        {!! Form::open(['url'=>'/cart_add', 'method'=>'POST' ]) !!}
                    <input type="hidden" name="id" value="{{$data->id}}">
                    <input type="hidden" name="img" value="12">
