            ...
            <div id="sequence" class="seq">
              <div class="seq-screen">
                <ul class="seq-canvas">
                  ...
                  <li>
                    <div class="seq-model">
                      <img data-seq src="{{ asset('front/img/slider/1.jpg')}}" alt="Men slide img" />
                    </div>
                    <div class="seq-title">
                  ...
                  <li>
                    <div class="seq-model">
                      <img data-seq src="{{ asset('front/img/slider/2.jpg')}}" alt="Wristwatch slide img" />
                    </div>
                    <div class="seq-title">
                  ...
                  <li>
                    <div class="seq-model">
                      <img data-seq src="{{ asset('front/img/slider/3.jpg')}}" alt="Women Jeans slide img" />
                    </div>
                    <div class="seq-title">
                      <span data-seq>Save Up to 75% Off</span>                
                  ...
                  <li>
                    <div class="seq-model">
                      <img data-seq src="{{ asset('front/img/slider/4.jpg')}}" alt="Shoes slide img" />
                    </div>
                    <div class="seq-title">
                      <span data-seq>Save Up to 75% Off</span>                
                  ...
                  <!-- single slide item -->  
                   <li>
                    <div class="seq-model">
                      <img data-seq src="{{ asset('front/img/slider/5.jpg')}}" alt="Male Female slide img" />
                    </div>
                    <div class="seq-title">
                    ...
                    <div class="col-md-5 no-padding">                
                      <div class="aa-promo-left">
                        <div class="aa-promo-banner">                    
                          <img src="{{ asset('front/img/promo-banner-1')}}.jpg" alt="img">                    
                    ...
                    <div class="col-md-7 no-padding">
                      <div class="aa-promo-right">
                        <div class="aa-single-promo-right">
                          <div class="aa-promo-banner">                      
                            <img src="{{ asset('front/img/promo-banner-3')}}.jpg" alt="img">                      
                            <div class="aa-prom-content">
                        ...
                        <div class="aa-single-promo-right">
                          <div class="aa-promo-banner">                      
                            <img src="{{ asset('front/img/promo-banner-2')}}.jpg" alt="img">                      
                            <div class="aa-prom-content">
                              <span>Sale Off</span>
                        ...
                        <div class="aa-single-promo-right">
                          <div class="aa-promo-banner">                      
                            <img src="{{ asset('front/img/promo-banner-4')}}.jpg" alt="img">                      
                            <div class="aa-prom-content">
                        ...
                        <div class="aa-single-promo-right">
                          <div class="aa-promo-banner">                      
                            <img src="{{ asset('front/img/promo-banner-5')}}.jpg" alt="img">                      
                            <div class="aa-prom-content">
                              <span>25% Off</span>
                        ...
                        <div class="tab-content">
                          ...
                          <div class="tab-pane fade in active" id="all">
                              <ul class="aa-product-catg">
                                ...
                                <li>
                                    <figure>
                                      <a class="aa-product-img" href="{{ route('prod_details', $d->id) }}"><img src="{{ asset('/upload/product/'.$d-> slug)}}" alt="polo shirt img"></a>
                                    <a class="aa-add-card-btn"href="{{url('home')}}"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                        <figcaption>
                                        <h4 class="aa-product-title"><a href="{{ route('prod_details', $d->id) }}">{{ $d-> name}}</a></h4>
                                        <span class="aa-product-price">N{{ $d->price}}</span><span class="aa-product-price"><del>N{{ $d->price}}</del></span>
                                      </figcaption>
                                    </figure>                        
                                    ...
                                    <!-- product badge -->
                                    <span class="aa-badge aa-{{$d->status}}" href="#">{{$d->status}}!</span>
                                  </li>
                          ...
                          <div class="tab-pane fade" id="men">
                            <ul class="aa-product-catg">
                              ...
                              <li>
                                <figure>
                                  <a class="aa-product-img" href="#"><img src="{{ asset('front/img/man/polo-shirt-2.png')}}" alt="polo shirt img"></a>
                              ...
                              <li>
                                <figure>
                                  <a class="aa-product-img" href="#"><img src="{{ asset('front/img/man/t-shirt-1.png')}}" alt="polo shirt img"></a>
                                  <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                   <figcaption>
                              ...
                              <li>
                                <figure>
                                  <a class="aa-product-img" href="#"><img src="{{ asset('front/img/man/polo-shirt-1.png')}}" alt="polo shirt img"></a>
                                  <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                   <figcaption>
                                    <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                    <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                              ...
                              <li>
                                <figure>
                                  <a class="aa-product-img" href="#"><img src="{{ asset('front/img/man/polo-shirt-4.png')}}" alt="polo shirt img"></a>
                                  <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                  <figcaption>
                                    <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                    <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                              ...
                              <li>
                                <figure>
                                  <a class="aa-product-img" href="#"><img src="{{ asset('front/img/man/polo-shirt-6.png')}}" alt="polo shirt img"></a>
                                  <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                  <figcaption>
                                    <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                    <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
